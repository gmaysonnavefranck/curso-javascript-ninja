(function(){
    ...
    */
    ...
    function cleanCPF(cpf){
        return cpf.replace(/(\d{3}).(\d{3}).(\d{3,4}).+?(\d{1,2})/, function(regex, parte1, parte2, parte3, parte4){
    ...
    */
    ...
    console.log(cleanCPF('049-214 3421-1').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function(regex, parte1, parte2, parte3, parte4){
        return parte1 + '.' + parte2 + '.' + parte3 + '-' + parte4;
    }));
    console.log(cleanCPF('210.458.522-05').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function(regex, parte1, parte2, parte3, parte4){
        return parte1 + '.' + parte2 + '.' + parte3 + '-' + parte4;
    }));
    console.log(cleanCPF('735 500 794 - 22').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function(regex, parte1, parte2, parte3, parte4){
        return parte1 + '.' + parte2 + '.' + parte3 + '-' + parte4;
    }));
    console.log(cleanCPF('101.123-131x32').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function(regex, parte1, parte2, parte3, parte4){
        return parte1 + '.' + parte2 + '.' + parte3 + '-' + parte4;
    }));
